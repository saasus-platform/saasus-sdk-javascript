...
async function runBillingE2E(): Promise<void> {
  loadEnv();

  console.log('🚀 Starting SaaSus Billing API E2E Tests');
  console.log('========================================');
...
runBillingE2E().catch(error => {
  console.error('Failed to execute billing E2E tests', error);
  process.exitCode = 1;
});
